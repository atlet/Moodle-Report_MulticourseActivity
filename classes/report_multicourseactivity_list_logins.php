...
class list_logins extends table_sql {
    ...
    public function __construct($uniqueid) {
        ...
        $this->define_columns(array('logins', 'uniqu_logins', 'timecreated'));
        $this->define_headers(array(
            get_string('logins', 'report_multicourseactivity'),
            get_string('uniqu_logins', 'report_multicourseactivity'),
            get_string('timecreated', 'report_multicourseactivity')
                )
        );
    ...
    function col_timecreated($attempt){
        return userdate($attempt->timecreated, get_string('strftimedate', 'langconfig'));
    }
