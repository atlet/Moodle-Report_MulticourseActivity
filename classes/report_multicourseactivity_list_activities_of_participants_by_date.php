...
class list_activities_of_participants_by_date extends table_sql {
    ...
    public function __construct($uniqueid) {
        ...
        $this->define_columns(array('skupna_aktivnost', 'dan_mesec_leto'));
        $this->define_headers(array(
            get_string('skupna_aktivnost', 'report_multicourseactivity'),
            get_string('dan_mesec_leto', 'report_multicourseactivity')
                )
        );
