...
class list_learners_activity_by_date extends table_sql {
    ...
    public function __construct($uniqueid) {
        ...
        $this->define_columns(array('stevilo_aktivnosti', 'st_aktivnih_uporabnikov', 'ucilnica'));
        $this->define_headers(array(
            get_string('stevilo_aktivnosti', 'report_multicourseactivity'),
            get_string('st_aktivnih_uporabnikov', 'report_multicourseactivity'),
